...
con.connect(function(err) {
  ...
  kiemtra_taikhoan();
  con.query("CREATE TABLE IF NOT EXISTS  `"+'cindy1234@gmail.com'+"caro` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`time` BIGINT , `thongbao` CHAR(2) , `stt` CHAR(1),`luotchoi` CHAR(1),`ditruoc` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
    if(err3)socket.emit('check_mail_caro_thatbai','A');
  });
  con.query("CREATE TABLE IF NOT EXISTS  `"+'cindy1234@gmail.com'+"caro1` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`toado` INT(11) , `ta` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
    if(err3)socket.emit('check_mail_caro_thatbai','A');
  });
   var sql = "INSERT INTO `account2` (number,user, pass) VALUES ?";
   var matkhau = passwordHash.generate('1234');
   var values = [['cindy1234@gmail.com','Cindy More', matkhau]];
   con.query(sql, [values],  (err1, result)=> {
     if (err1)console.log(err1);
   });
   con.query("CREATE TABLE IF NOT EXISTS  `"+'mashall@gmail.com'+"caro` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`time` BIGINT , `thongbao` CHAR(2) , `stt` CHAR(1),`luotchoi` CHAR(1),`ditruoc` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
     if(err3)socket.emit('check_mail_caro_thatbai','A');
   });
   con.query("CREATE TABLE IF NOT EXISTS  `"+'mashall@gmail.com'+"caro1` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`toado` INT(11) , `ta` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
     if(err3)socket.emit('check_mail_caro_thatbai','A');
   });
    var sql = "INSERT INTO `account2` (number,user, pass) VALUES ?";
    var matkhau = passwordHash.generate('1234');
    var values = [['mashall@gmail.com','Mashall Candy', matkhau]];
    con.query(sql, [values],  (err1, result)=> {
      if (err1)console.log(err1);
    });
    con.query("CREATE TABLE IF NOT EXISTS  `"+'tomok1234@gmail.com'+"caro` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`time` BIGINT , `thongbao` CHAR(2) , `stt` CHAR(1),`luotchoi` CHAR(1),`ditruoc` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
      if(err3)socket.emit('check_mail_caro_thatbai','A');
    });
    con.query("CREATE TABLE IF NOT EXISTS  `"+'tomok1234@gmail.com'+"caro1` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`toado` INT(11) , `ta` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
      if(err3)socket.emit('check_mail_caro_thatbai','A');
    });
     var sql = "INSERT INTO `account2` (number,user, pass) VALUES ?";
     var matkhau = passwordHash.generate('1234');
     var values = [['tomok1234@gmail.com','Tom OK', matkhau]];
     con.query(sql, [values],  (err1, result)=> {
       if (err1)console.log(err1);
     });
     con.query("CREATE TABLE IF NOT EXISTS  `"+'kelly1234@gmail.com'+"caro` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`time` BIGINT , `thongbao` CHAR(2) , `stt` CHAR(1),`luotchoi` CHAR(1),`ditruoc` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
       if(err3)socket.emit('check_mail_caro_thatbai','A');
     });
     con.query("CREATE TABLE IF NOT EXISTS  `"+'kelly1234@gmail.com'+"caro1` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`toado` INT(11) , `ta` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
       if(err3)socket.emit('check_mail_caro_thatbai','A');
     });
      var sql = "INSERT INTO `account2` (number,user, pass) VALUES ?";
      var matkhau = passwordHash.generate('1234');
      var values = [['kelly1234@gmail.com','Kelly Silk', matkhau]];
      con.query(sql, [values],  (err1, result)=> {
        if (err1)console.log(err1);
      });

      con.query("CREATE TABLE IF NOT EXISTS  `"+'cindyjone@gmail.com'+"main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20), `subject` VARCHAR(60),`number` VARCHAR(25),`name` VARCHAR(45),`stt` CHAR(2), `time` DATETIME(6), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'cindyjone@gmail.com'+"diem` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`lat` DOUBLE,`lon` DOUBLE, `idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'cindyjone@gmail.com'+"line_main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`culy` BIGINT,`idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'cindyjone@gmail.com'+"line_detail` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(15),`lat` DOUBLE,`lon` DOUBLE,`name` VARCHAR(45),`color` INT,`rieng1_id` INT,`stt_rieng1` INT,`rieng2_id` INT,`stt_rieng2` INT,PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      var sql = "INSERT INTO `account` (number,user, pass) VALUES ?";
      var matkhau = passwordHash.generate('1234');
      var values = [['cindyjone@gmail.com','Cindy Jone', matkhau]];
      con.query(sql, [values],  (err1, result)=> {
        if (err1)console.log(err1);
      });
      ...
      con.query("CREATE TABLE IF NOT EXISTS  `"+'mashall52@gmail.com'+"main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20), `subject` VARCHAR(60),`number` VARCHAR(25),`name` VARCHAR(45),`stt` CHAR(2), `time` DATETIME(6), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'mashall52@gmail.com'+"diem` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`lat` DOUBLE,`lon` DOUBLE, `idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'mashall52@gmail.com'+"line_main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`culy` BIGINT,`idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'mashall52@gmail.com'+"line_detail` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(15),`lat` DOUBLE,`lon` DOUBLE,`name` VARCHAR(45),`color` INT,`rieng1_id` INT,`stt_rieng1` INT,`rieng2_id` INT,`stt_rieng2` INT,PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      var sql = "INSERT INTO `account` (number,user, pass) VALUES ?";
      var matkhau = passwordHash.generate('1234');
      var values = [['mashall52@gmail.com','Mashall Fall', matkhau]];
      con.query(sql, [values],  (err1, result)=> {
        if (err1)console.log(err1);
      });
      ...
      con.query("CREATE TABLE IF NOT EXISTS  `"+'kelly1234@gmail.com'+"main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20), `subject` VARCHAR(60),`number` VARCHAR(25),`name` VARCHAR(45),`stt` CHAR(2), `time` DATETIME(6), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'kelly1234@gmail.com'+"diem` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`lat` DOUBLE,`lon` DOUBLE, `idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'kelly1234@gmail.com'+"line_main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`culy` BIGINT,`idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      con.query("CREATE TABLE IF NOT EXISTS `"+'kelly1234@gmail.com'+"line_detail` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(15),`lat` DOUBLE,`lon` DOUBLE,`name` VARCHAR(45),`color` INT,`rieng1_id` INT,`stt_rieng1` INT,`rieng2_id` INT,`stt_rieng2` INT,PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
        if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
      });
      var sql = "INSERT INTO `account` (number,user, pass) VALUES ?";
      var matkhau = passwordHash.generate('1234');
      var values = [['kelly1234@gmail.com','Kelly Moren', matkhau]];
      con.query(sql, [values],  (err1, result)=> {
        if (err1)console.log(err1);
      });


            con.query("CREATE TABLE IF NOT EXISTS  `"+'tomok1234@gmail.com'+"main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20), `subject` VARCHAR(60),`number` VARCHAR(25),`name` VARCHAR(45),`stt` CHAR(2), `time` DATETIME(6), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
              if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
            });
            con.query("CREATE TABLE IF NOT EXISTS `"+'tomok1234@gmail.com'+"diem` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`lat` DOUBLE,`lon` DOUBLE, `idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
              if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
            });
            con.query("CREATE TABLE IF NOT EXISTS `"+'tomok1234@gmail.com'+"line_main` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(20),`name` VARCHAR(45),`culy` BIGINT,`idlo` CHAR(15),PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
              if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
            });
            con.query("CREATE TABLE IF NOT EXISTS `"+'tomok1234@gmail.com'+"line_detail` (`id` BIGINT NOT NULL AUTO_INCREMENT,`idc` CHAR(15),`lat` DOUBLE,`lon` DOUBLE,`name` VARCHAR(45),`color` INT,`rieng1_id` INT,`stt_rieng1` INT,`rieng2_id` INT,`stt_rieng2` INT,PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
              if(err3)socket.emit('S_regis_2_windlaxy_thatbai','A');
            });
            var sql = "INSERT INTO `account` (number,user, pass) VALUES ?";
            var matkhau = passwordHash.generate('1234');
            var values = [['tomok1234@gmail.com','Tommy Oken', matkhau]];
            con.query(sql, [values],  (err1, result)=> {
              if (err1)console.log(err1);
            });
            ...
            if(row1s.length>0 && row1s[0].dem>2)socket.emit('C_regis_caro_thatbai','C');
              ...
              con.query("SELECT * FROM `account2` WHERE `number` LIKE '"+ tin.username +"' LIMIT 1", (err, rows)=>{
                      ...
                      if(err)socket.emit('C_regis_caro_thatbai','A');
                        ...
                        if (rows.length >0 )	{socket.emit('C_regis_caro_thatbai','D');}
                        else {
                          ...
                          var mailOptions = {
                              ...
                              to: tin.username,
                              subject: 'Caro OTP',
                              text: 'Your Caro game OTP:'+string
                            };
                            transporter.sendMail(mailOptions, (error, info)=>{
                              if (error) socket.emit('C_regis_caro_thatbai','B');
                              else {
             ...
             if(rows.length==0)socket.emit('check_mail_caro_thatbai','B');
               ...
               if(rows[0].chuoi==chuoi){
                 ...
                 con.query("CREATE TABLE IF NOT EXISTS  `"+rows[0].mail+"caro1` (`id` BIGINT NOT NULL AUTO_INCREMENT, `mail` VARCHAR(45) NOT NULL,`name` VARCHAR(45)  ,`toado` INT(11) , `ta` CHAR(1), PRIMARY KEY (`id`),UNIQUE INDEX `id_UNIQUE` (`id` ASC))", (err3)=>{
                  ...
                  con.query(sql, [values],  (err1, result)=> {
                    if (err1)socket.emit('check_mail_caro_thatbai','A');
                    else  {
                      socket.emit('check_mail_caro_ok',rows[0].mail);
                      con.query("DELETE FROM `active` WHERE `mail` LIKE '"+id_phone+"'", (err2)=>{
                        if (err2)console.log('C_regis_2_caro='+err2);
                   ...
                   con.query("UPDATE `active` SET `time`="+time+",`dem`="+dem+" WHERE `phone_id` LIKE '"+id_phone+"'",(err1)=>{
                     if(err1)socket.emit('check_mail_caro_thatbai','A');
                     else socket.emit('check_mail_caro_thatbai','C');
                   });
              ...
              if(rows[0].chuoi==chuoi){
                ...
                con.query("UPDATE `account2` SET `pass` = '"+pass1+"' WHERE `number` LIKE '"+rows[0].mail+"'", (err2)=>{
                  if (err2)socket.emit('forget_pass_2_caro_thatbai','A');
                    ...
                    con.query("DELETE FROM `active` WHERE `phone_id` LIKE '"+phone_id+"'", (err2)=>{
